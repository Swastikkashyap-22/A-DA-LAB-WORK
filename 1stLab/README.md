...
* x: Base integer
* n: Exponent integer
* m: Temporary copy of exponent
* z: Temporary copy of base
* Pow: Accumulator
* start, stop, duration: Execution time tracking
...
To solve the classic Tower of Hanoi puzzle using recursion.
...
To find number of bounces based on velocity decay.
